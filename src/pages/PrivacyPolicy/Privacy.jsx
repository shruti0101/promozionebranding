        ...
        <div className="container">
          ...
          <div className="">
            <ul className="list-unstyled">
              <li className="fw-bold fs-4">1. Introduction </li>
              <div
                className="my-3 text-muted fw-semibold"
                style={{ fontSize: "1.1rem" }}
              >
                <p>
                  <p>
                    Welcome to{" "}
                    <strong>Promozione Branding Private Limited.</strong>
                  </p>{" "}
                  Promozione Branding Private Limited (“us”, “we”, or “our”)
                  operates{" "}
                  <a
          ...
          <div className="mt-4">
            <ul className="list-unstyled">
              <li className="fw-bold fs-4">2. Definitions </li>
              <div
                className="my-3 text-muted fw-semibold"
                style={{ fontSize: "1.1rem" }}
              >
          ...
          <div className="mt-4">
            <ul className="list-unstyled">
              <li className="fw-bold fs-4">4. Types of Data Collected </li>
              <div
                className="my-3 text-muted fw-semibold"
                style={{ fontSize: "1.1rem" }}
              >
                <p>
                  ...
                  <li className="my-2">0.1. Email address</li>
                  <li className="my-2">0.2. First name and last name</li>
                  <li className="my-2">0.3. Phone number</li>
                  <li className="my-2">
                    0.4. Address, Country, State, Province, ZIP/Postal code,
                    City
                  </li>
                  <li className="my-2">0.5. Cookies and Usage Data</li>
                  <p className="mt-4">
                ...
                <li className="my-2 ">
                  0.1. <strong>Session Cookies:</strong> We use Session Cookies
          ...
          <div>
            <li className="fw-bold fs-4 list-unstyled my-3">
              4. Types of Data Collected{" "}
            </li>
            <p>
              Promozione Branding Private Limited uses the collected data for
              various purposes:
            </p>

            <div
              className="list-unstyled  text-muted fw-semibold "
              style={{ fontSize: "1.1rem" }}
            >
              <li className="my-2">
              ...
              <li className="my-2">0.4. to provide customer support;</li>
              <li className="my-2">
          ...
          <div className="my-4 ">
            <ul className="list-unstyled">
              <li className="fw-bold fs-4"> 6. Retention of Data</li>
              <div
                className="my-3 text-muted fw-semibold"
                style={{ fontSize: "1.1rem" }}
              >
          ...
          <div className="my-4 ">
            <ul className="list-unstyled">
              <li className="fw-bold fs-4"> 7. Transfer of Data</li>
              <div
                className="my-3 text-muted fw-semibold"
                style={{ fontSize: "1.1rem" }}
              >
                ...
                <p>
                  If you are located outside Asia and choose to provide
                  information to us, please note that we transfer the data,
                  including Personal Data, to Asia and process it there.
                </p>
                ...
                <p>
                  Promozione Branding Private Limited will take all the steps
          ...
          <div className="my-4 ">
            <ul className="list-unstyled">
              <li className="fw-bold fs-4"> 8. Disclosure of Data</li>
              <div
                className="my-3 text-muted fw-semibold"
                style={{ fontSize: "1.1rem" }}
              >
                ...
                <p className="fw-bold ">0.2. Business Transaction. </p>
                <p>
          ...
          <div className="my-4 ">
            <ul className="list-unstyled">
              <li className="fw-bold fs-4"> 9. Security of Data</li>
              <div
                className="my-3 text-muted fw-semibold"
                style={{ fontSize: "1.1rem" }}
              >
          ...
          <div className="my-4 ">
            <ul className="list-unstyled">
              ...
              >
                ...
                us at <span className="text-primary"></span>{" "}
                ...
                <p>
                  0.1. the right to access, update or to delete the information
                  we have on you;
                </p>
                <p>
          ...
          <div className="my-4 ">
            <ul className="list-unstyled">
              ...
              >
                ...
                <p>
                  0.3. users will be notified of any privacy policy changes on
                  our Privacy Policy Page;
                </p>

                <p>
                  0.4. users are able to change their personal information by
                  emailing us at info@promozionebranding.com.
                </p>
            ...
            <ul className="list-unstyled">
              ...
              >
                ...
                <p>
                  ...
                  Information website. The CCPA took effect on 01/01/2023.
                </p>
              </div>
            </ul>
          </div>
          ...
          <div className="my-4 ">
            <ul className="list-unstyled">
              <li className="fw-bold fs-4"> 13. Service Providers</li>
              <div
                className="my-3 text-muted fw-semibold"
                style={{ fontSize: "1.1rem" }}
              >
          ...
          <div className="my-4 ">
            <ul className="list-unstyled">
              <li className="fw-bold fs-4"> 14. Analytics</li>
              <div
                className="my-3 text-muted fw-semibold"
                style={{ fontSize: "1.1rem" }}
              >
          ...
          <div className="my-4 ">
            <ul className="list-unstyled">
              <li className="fw-bold fs-4"> 15. CI/CD tools</li>
              <div
                className="my-3 text-muted fw-semibold"
                style={{ fontSize: "1.1rem" }}
              >
          ...
          <div className="my-4 ">
            <ul className="list-unstyled">
              <li className="fw-bold fs-4"> 16. Behavioral Remarketing</li>
              <div
                className="my-3 text-muted fw-semibold"
                style={{ fontSize: "1.1rem" }}
              >
          ...
          <div className="my-4 ">
            <ul className="list-unstyled">
              <li className="fw-bold fs-4"> 17. Links to Other Sites</li>
              <div
                className="my-3 text-muted fw-semibold"
                style={{ fontSize: "1.1rem" }}
              >
          ...
          <div className="my-4 ">
            <ul className="list-unstyled">
              <li className="fw-bold fs-4"> 18. Children’s Privacy</li>
              <div
                className="my-3 text-muted fw-semibold"
                style={{ fontSize: "1.1rem" }}
              >
                <p>
                  ...
                  age of 18 <strong>(“Child” or “Children”).</strong>
                </p>
                <p>
          ...
          <div className="my-4 ">
            <ul className="list-unstyled">
              <li className="fw-bold fs-4"> 20. Contact Us</li>
              <div
                className="my-3 text-muted fw-semibold"
                style={{ fontSize: "1.1rem" }}
              >
