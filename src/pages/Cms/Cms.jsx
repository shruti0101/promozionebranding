...
const Cms = () => {
  ...
  const steps = [
    ...
    {
      icon: <FaPencilRuler />,
      title: "Step 2: CMS Recommendation",
          ...
          <div className="row align-items-center">
            ...
            <div className="col-md-7">
              <h2 className="display-6 fw-bold mb-4">
                Why Choose Our
                <span className="text-highlight"> CMS Development </span>
                Services?
              </h2>

              <p className="fw-semibold">
                If you can use MS Word, you can use a CMS. Itna easy hai. Update
                content, images, and blogs from your laptop or mobile. No dev
                dependency.
              </p>
              ...
              >
                <div style={{ zIndex: 2, position: "relative" }}>
                  ...
                  <p className="mb-3 text-dark fs-6">
                    Tired of saying “developer ko bolna padega”? Ab apni website
                    ka full control aapke haath mein.
                  </p>
        ...
        <div className="container position-relative">
          <div className="text-center mb-5" data-aos="fade-up">
            <h2 className="fw-bold display-6">
              Our <span style={{ color: "#2548BD" }}>CMS Development</span>{" "}
              Process
            </h2>
          </div>
