...
"
          ...
          <div className="row align-items-center flex-wrap-reverse">
            ...
            <div className="col-md-6" data-aos="fade-right">
              <h2 className="php-heading">
                What is{" "}
                <span style={{ color: "#2548BD" }}>Digital Marketing?</span>{" "}
              </h2>
              <p className="php-desc">
                <strong>Digital Marketing</strong> is the art (and science) of
                promoting your business online using: Search engines like Google
                Social media platforms like Facebook, Instagram, and LinkedIn
                Email, SMS & WhatsApp marketing Websites, content, videos & more
                It’s not just about running ads — it’s about building a brand
                that grows in traffic, leads, and sales —{" "}
                <strong>month after month.</strong>
              </p>
            </div>
      ...
      <WhyChoose
        title="Why Choose
"
        highlightedText=" Promozione for  Digital Marketing?"
        features={features}
...
"
 ...
 "
      ...
      <Service
        title="Our Core  Digital Marketing Services:
"
        subtitle="Signs You Need  Digital Marketing Services
